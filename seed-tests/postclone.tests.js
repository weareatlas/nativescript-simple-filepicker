...
describe('postclone', function () {
    ...
    it('should replace each SimpleWebView string', function (done) {
        testUtils.findInFiles("SimpleWebView", constants.SEED_COPY_LOCATION, function (resultsCount) {
            expect(resultsCount).toEqual(0);
            done();
        });
    });
    ...
    it('should replace each SimpleWebView string with ThePlugin', function (done) {
    ...
    it('should replace each nativescript-SimpleWebView string with nativescript-ThePlugin', function (done) {
